...
# albedo range (~0.29-0.78) with minimal redundancy: near-identical broadband
# values (gap < ~0.02) were dropped, keeping one representative each. The inline
# value is the TOA-solar-flux-weighted broadband albedo (recomputed 2026-07-17
# with the 250-4050 nm slit solar file; the old 2500 nm file gave values
# ~0.013-0.019 higher).
# ---------------------------------------------------------------------------
MANUAL_ALB_SWEEP = [
    'sfc_alb_20240801_13.843_14.351_0.11km_cre_alb.dat',             # 0.288
    'sfc_alb_20240725_15.881_15.903_0.33km_cre_alb.dat',             # 0.530
    'sfc_alb_20240808_13.212_13.345_0.12km_cre_alb.dat',             # 0.553
    'sfc_alb_20240808_15.314_15.497_0.12km_cre_alb_scale_1.012X.dat',  # 0.594
    'sfc_alb_20240809_16.029_16.224_0.11km_cre_alb.dat',             # 0.624
    'sfc_alb_20240611_14.968_15.347_0.41km_cre_alb.dat',             # 0.655
    'sfc_alb_20240613_14.109_14.140_0.11km_cre_alb.dat',             # 0.661  (case_019 own albedo)
    'sfc_alb_20240528_15.610_17.404_0.18km_cre_alb.dat',             # 0.683
    # 0.694 (sfc_alb_20240613_15.834_..._scale_0.987X) dropped: thinned the tight
    # 0.683/0.694/0.704 cluster near 0.7 that kinked the critical-LWP contour.
    'sfc_alb_20240611_14.968_15.347_0.12km_cre_alb.dat',             # 0.704
    # 0.732 (case_004 full-window) and one near-duplicate dropped: redundant with
    # the 0.742 observation below; their tight clustering kinked the critical-LWP
    # contour. The peak 1-min albedo (also 0.742) is commented out because it
    # collides with the 2-min broadband bin and corrupts that albedo's
    # critical-LWP column.
    ...
    'sfc_alb_20240606_16.250_16.950_0.11km_cre_alb.dat',             # 0.758
    'sfc_alb_20240606_16.250_16.950_1.18km_cre_alb.dat',             # 0.778
]
